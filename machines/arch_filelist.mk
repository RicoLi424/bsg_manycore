...
VHEADERS += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_pkg.v
...
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_misc/bsg_gear_splitter.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_misc/bsg_gear_combinator.v
...
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_mem/bsg_mem_1r1w_one_hot_mask_write_bit.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_mem/bsg_mem_1r1w_one_hot_reset.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_mem/bsg_mem_1r1w_one_hot_mask_write_byte.v
...
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_tag_mgmt_unit.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_read_miss_queue.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_miss_fill_way_chooser.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_mshr_cam.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_mhu.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_evict_fill_transmitter.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_op_decode.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_dma.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_dma_to_wormhole.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_sbuf_snoop.v
VSOURCES += $(BASEJUMP_STL_DIR)/bsg_cache/bsg_cache_nb_tbuf_snoop.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_link_to_cache_nb.v
...
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_pod_mesh_array.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_pod_mesh.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_pod_mesh_row.v
...
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_tile_compute_array_mesh.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_tile_compute_mesh.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_tile_vcache_array.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_tile_vcache.v
VSOURCES += $(BSG_MANYCORE_DIR)/v/bsg_manycore_tile_vcache_nb.v
